...
namespace Samples.Converters
{
    ...
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => DateTimeOffset.FromUnixTimeMilliseconds((long)value).ToString("dd/MM hh:mm tt");
